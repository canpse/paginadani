...
- [x] CRUD completo de midias
- [x] filtros e ordenacao
...
## Criterio de pronto da fase atual
- [x] produto utilizavel de ponta a ponta
- [x] build sem erros
- [x] deploy para testes no Vercel
- [ ] aprovacao de UX pela usuaria final
